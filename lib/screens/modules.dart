            ...
            child: Column(
              ...
              children: <Widget>[
                Stack(
                  ...
                  Container(
                      alignment: Alignment.center,
                      child: const Text("Modules recommended for you", style: TextStyle(
                        fontSize: 20,
                ...
                padding: const EdgeInsets.only(left: 32),
                  ...
                  child: Swiper(
                    ...
                    pagination: SwiperPagination(
                      builder:
                      DotSwiperPaginationBuilder(activeSize: 20, space: 8, color: Colors.blueGrey),
                    ),
